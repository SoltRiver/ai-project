...
class EdinetDocument(Base):
    ...
    target_date = Column(Date, index=True, nullable=False) # The date searched (documents.json?date=...)
    ...
    xbrl_flag = Column(String(1), nullable=True) # "1" or "0" (Using String to match API/Postgres char(1))
