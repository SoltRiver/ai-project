...
SINGLE_CANDLE_KEYS = {
    "big_bull", "small_bull", "upper_shadow_bull", "lower_shadow_bull", "bozu_bull",
    "big_bear", "small_bear", "upper_shadow_bear", "lower_shadow_bear", "bozu_bear",
    "doji", "upper_shadow_doji", "lower_shadow_doji", "marubozu_doji", 
    "dragonfly_doji", "gravestone_doji", "koma", "long_legged_doji",
    "kubitsuri"
}
...
PATTERNS = {
    ...
    # Advanced
    "bull_engulfing": [Candle(0, 55, 45, 60, 40), Candle(1, 40, 60, 65, 35)], # Bear then Big Bull wrapping
    "bear_engulfing": [Candle(0, 45, 55, 60, 40), Candle(1, 60, 40, 65, 35)], # Bull then Big Bear wrapping
    "harami": [Candle(0, 20, 80, 85, 15), Candle(1, 60, 40, 65, 35)], # Big Bull then Small Bear inside
    "bull_bear_harami": [Candle(0, 80, 20, 85, 15), Candle(1, 40, 60, 65, 35)], # Big Bear then Small Bull inside (Was inyo_harami)
    
    "kiriage": [Candle(0, 30, 50, 55, 25), Candle(1, 55, 75, 80, 50)], # Rising lows
    "kirisage": [Candle(0, 70, 50, 55, 45), Candle(1, 45, 25, 30, 20)], # Lowering highs (Bearish)
    
    "kabuse": [Candle(0, 30, 70, 75, 25), Candle(1, 80, 45, 85, 40)], # Gap up open, close below mid
    "sashikomi": [Candle(0, 70, 30, 75, 25), Candle(1, 20, 45, 50, 15)], # Gap down open, close above mid
    
    "kenuki_zoko": [Candle(0, 60, 30, 65, 10), Candle(1, 35, 55, 60, 10)], # Matching Lows
    "kenuki_tenjo": [Candle(0, 40, 70, 90, 35), Candle(1, 65, 45, 90, 40)], # Matching Highs
    
    "daki_bull": [Candle(0, 55, 45, 58, 42), Candle(1, 40, 60, 65, 35)], # Same as Engulfing Bull
    "daki_bear": [Candle(0, 45, 55, 58, 42), Candle(1, 60, 40, 65, 35)], # Same as Engulfing Bear
    
    "kaeshi": [Candle(0, 30, 70, 75, 25), Candle(1, 70, 30, 75, 25)], 
    "kubitsuri": [Candle(0, 40, 50, 55, 10)], # Hanging Man (Bearish tone usually, but shape is Hammer)
    
    "three_white_soldiers": [Candle(0, 20, 40, 45, 15), Candle(1, 40, 60, 65, 35), Candle(2, 60, 80, 85, 55)],
    "three_black_crows": [Candle(0, 80, 60, 85, 55), Candle(1, 60, 40, 65, 35), Candle(2, 40, 20, 45, 15)],
    
    "sanbagarasu": [Candle(0, 80, 60, 85, 55), Candle(1, 60, 40, 65, 35), Candle(2, 40, 20, 45, 15)], # Alias for crows
    "sanku_tatakikomi": [
    ...
    "gap_fill": [Candle(0, 20, 40, 45, 15), Candle(1, 55, 35, 60, 30)], # Gap up then fill down
