...
def verify_v2():
    ...
    if not api_key:
        print("WARNING: JQUANTS_API_KEY is missing. Migration verification will likely fail unless Refresh Token works as API Key (unlikely).")
    ...
    try:
        ...
        if issues:
            ...
            if "Code" in first and ("CompanyName" in first or "Name" in first):
                ...
                print("COMPATIBILITY WARN: Keys might have changed. StockService logic needs update.")
        else:
