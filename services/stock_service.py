...
def get_watchlist_codes(db: Session) -> List[str]:
    try:
        stocks = (
            db.query(stock_model.Stock)
            .order_by(stock_model.Stock.sort_order.asc(), stock_model.Stock.id.asc())
            .all()
        )
...
def add_stock_to_watchlist(db: Session, code: str) -> bool:
    try:
        existing = (
            db.query(stock_model.Stock).filter(stock_model.Stock.code == code).first()
        )
        if existing:
            return False
...
def remove_stocks_from_watchlist(db: Session, codes: List[str]):
    try:
        db.query(stock_model.Stock).filter(stock_model.Stock.code.in_(codes)).delete(
...
CANDLE_PATTERN_CARDS = [
    # Basic Bullish
    {
        ...
        "action": "強気買い（続伸を狙う）",
        "tips": [
            "上下にヒゲがない陽線は、始値から終値まで一方的に買われた極めて強い形です。",
            "大陽線の一種であり、翌日も上昇する可能性が高いです。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "上ヒゲがない陽線は、引けにかけて買いの勢いが衰えなかったことを示します。",
            "大陽線の一種であり、強い上昇圧力が継続しています。",
        ],
        "desc_lead": "上ヒゲがない陽線",
    ...
    },
    {
        ...
        "action": "買い（押し目買い）",
        "tips": [
            "下ヒゲがない陽線は、寄り付きから一度も始値を割らずに上昇した形です。",
            "大陽線の一種であり、始値が強力なサポートとして意識されています。",
        ],
        "desc_lead": "下ヒゲがない陽線",
    ...
    },
    {
        ...
        "tips": [
            "実体が小さく下ヒゲが長い陽線は、安値圏で出ると強力な反発サインです。",
            "下影陽線の一種であり、売り圧力を跳ね返した証拠です。",
        ],
    ...
    },
    {
        ...
        "action": "警戒（上値の重さを確認）",
        "tips": [
            "実体が小さく上ヒゲが長い陽線は、上昇しようとしたが押し戻された形です。",
            "上影陽線の一種であり、高値圏では天井打ちの懸念があります。",
        ],
    ...
    },
    {
        ...
        "action": "様子見（次の一手を待つ）",
        "tips": [
            "価格帯により意味が変わるため、翌日のローソク足がどちらに放れるかを確認してから動きましょう。",
            "安値圏であれば下げ止まりの予兆、高値圏であれば失速の懸念があります。",
        ],
        "desc_lead": "実体の短い陽線",
    ...
    # Basic Bearish
    {
        ...
        "action": "売り（続落を警戒）",
        "tips": [
            "上下にヒゲがない陰線は、始値から終値まで一方的に売られた極めて弱い形です。",
            "大陰線の一種であり、翌日も下落する可能性が高いです。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "下ヒゲがない陰線は、引けにかけて売りが止まらなかったことを示します。",
            "大陰線の一種であり、下落圧力が依然として強いです。",
        ],
        "desc_lead": "下ヒゲがない陰線",
    ...
    },
    {
        ...
        "action": "売り（戻り売り）",
        "tips": [
            "上ヒゲがない陰線は、寄り付きから一度も始値を超えられずに下落した形です。",
            "大陰線の一種であり、始値が強力なレジスタンスとなっています。",
        ],
        "desc_lead": "上ヒゲがない陰線",
    ...
    },
    {
        ...
        "action": "様子見（首吊り線に注意）",
        "tips": [
            "実体が小さく下ヒゲが長い陰線です。安値圏なら反発の兆しですが、高値圏では「首吊り線」となり急落の合図です。",
            "下影陰線の一種です。出現場所により意味が逆転するため注意が必要です。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "実体が小さく上ヒゲが長い陰線は、上昇の試みが完全に否定された形です。",
            "上影陰線の一種であり、非常に弱い形です。",
        ],
    ...
    },
    {
        ...
        "action": "様子見（下げ止まりを待つ）",
        "tips": [
            "下落トレンド中の出現は底打ちの予兆になることがあるため、翌日の陽線出現を待ってから判断してください。",
            "上昇トレンド中の場合は、健全な押し目となる可能性があります。",
        ],
        "desc_lead": "実体の短い陰線",
    ...
    # Basic Neutral (Doji)
    {
        ...
        "tips": [
            "売り手と買い手の勢力が均衡しており、相場の転換点になりやすい形です。",
            "翌日のローソク足が前日の高値を抜けるか、安値を割るかを確認してからエントリーしてください。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "上昇力の限界を示しています。高値圏で出現した場合、翌日に安値を割り込む動きがあれば反落のシグナルとなります。",
            "「墓石」とも呼ばれ、ここを頂点にトレンドが変わることが多い形です。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "強力な下支えがあることを示しています。安値圏で出た場合、翌日に陽線が出現すれば底打ちが確定しやすくなります。",
            "トレンドの底を見極める重要なサインです。",
        ],
    ...
    },
    {
        ...
        "action": "様子見（商いの増加を待つ）",
        "tips": [
            "出来高が極端に少ないか、大きな材料待ちの状態です。無理に手を出さず、大きな陽線または陰線が出て動き出すのを待ちましょう。",
            "流動性が低い銘柄では頻出するため注意が必要です。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "安値圏では非常に強力な反発サインです。寄り付き価格を維持している限り、強気の姿勢を保てます。",
            "翌日に窓を開けて上昇すれば、本格的な反騰の合図となります。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "上昇エネルギーが完全に枯渇した状態です。高値圏でこの形が出たら、欲をかかずに一度ポジションを外すことを強く検討してください。",
            "翌日の続落を待つと逃げ遅れるリスクがあります。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "エネルギー蓄積の段階です。現在のレンジをどちらに大きく放れるかを確認するまで、不用意な売買は避けるのが賢明です。",
            "トレンドの途中で出た場合は、中休みの可能性があります。",
        ],
        "desc_lead": "実体もヒゲも短い形",
    ...
    },
    {
        ...
        "tips": [
            "相場が非常に不安定な状態です。高値圏や安値圏で出た場合、翌日に大きく窓を開けて動き出した方向に付いていくのが基本です。",
            "ヒゲの範囲内は「嵐の目」であり、手を出さないのが無難です。",
        ],
    ...
    # Advanced 2-Candle
    {
        ...
        "tips": [
            "前日の陰線を完全に飲み込む陽線は、強力な反転サインです。安値圏で出た場合、翌日の寄り付きが陽線実体内であれば強気で買いを検討できます。",
            "出来高が伴っていれば信頼性はさらに高まります。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "上昇トレンドの終焉を示唆します。陽線を完全に飲み込む陰線が出たら、まずは利益確定を最優先してください。",
            "翌日に窓を開けて下落が始まる場合は、下げが加速するリスクが高いです。",
        ],
    ...
    },
    {
        ...
        "action": "様子見（レンジを上抜けるまで待ち）",
        "tips": [
            "大きな陰線の後に小さな陽線が現れる「はらみ」は、売りが止まったサインです。翌日、1本目の実体の高値を上抜けてくれば買いのチャンスです。",
            "焦って買うよりも、放れを確認する順張りが安全です。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "徐々に安値を切り上げている状態であり、買い手の意欲が高まっています。直近の抵抗線を越えれば、上昇トレンドへと発展する可能性が高いです。",
            "「押し目」としても機能しやすい形です。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "高値を更新できず、徐々に価格帯が下がっている非常に重い形です。サポートラインを割り込むと、下落に拍車がかかります。",
            "早めの損切り、または空売りを検討する局面です。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "上昇にブレーキがかかった強いサインです。特に「かぶせ」の陰線の終値が、前日陽線の中心より下にあるほど反落の確度が高まります。",
            "翌日に窓を開けて下落すれば、トレンド転換が決定づけられます。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "反発の兆しは見えますが、前日の陰線の中心を越えられない「差し込み」は、まだ下落圧力が根強いことを示しています。",
            "翌日に前日終値を上回れなければ、再下落のリスクがあるため注意が必要です。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "2本の足の安値がほぼ一致しており、その価格帯が強力な岩盤（サポート）になっていることを示します。安値圏で出た場合、非常に信頼度の高い底打ちサインです。",
            "下ヒゲが長いほど、反発力はより強固になります。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "2本の足の高値が一致し、上昇が阻まれた形です。高値圏でこの形が出たら、上昇エネルギーが完全に枯渇したと判断し、早期の利確を検討してください。",
            "ダブルトップの非常に短いスパンでの形成とも言えます。",
        ],
    ...
    },
    {
        ...
        "action": "買い（トレンド転換を狙う）",
        "tips": [
            "前日の実体を完全に包み込む大陽線は、相場の主導権が買い方に移ったことを示します。安値圏での出現は、絶好の買い場となります。",
            "包み足と同意ですが、特に「抱き」と呼ばれる場合は勢いの強さが強調されます。",
        ],
        "desc_lead": "前日の陰線を陽線が完全に包み込む",
    ...
    },
    {
        ...
        "action": "売り（即時撤退を推奨）",
        "tips": [
            "上昇トレンドを完全に帳消しにする強烈な売りです。高値圏で発生すると、その後数日間にわたる本格的な調整に入るリスクが高いです。",
            "迷わずポジションを縮小すべき局面です。",
        ],
        "desc_lead": "前日の陽線を陰線が完全に包み込む",
    ...
    },
    {
        ...
        "tips": [
            "前日の動きをそのまま打ち消す逆の足が出る「返し」は、売り買いが非常に激しく拮抗している証拠です。現在の価格帯が強い抵抗、または支持になっている可能性があります。",
            "レンジの中央として機能しやすいため、どちらかに窓を開けて放れるのを待ちましょう。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "高値圏で出現する下ヒゲの長い小陰線は、買い支えが限界に来ていることを示します。翌日に安値を更新して始まれば、一気にパニック売りが広がるリスクがあるため、利確を急ぎましょう。",
            "形は「ハンマー」に似ていますが、出現場所が高値圏である場合は正反対の最悪なサインとなります。",
        ],
    ...
    # Advanced 3-Candle
    {
        ...
        "action": "買い（強いトレンドに乗る）",
        "tips": [
            "安値圏で窓を開けずに陽線が3本続くのは、本格的な上昇トレンドの開始を意味します。各陽線の高値が着実に切り上がっていることを確認し、順張りでエントリーしましょう。",
            "ヒゲが短いほど買い手の意志が強く、信頼性が高まります。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "上昇トレンドの崩壊を示唆する非常に強い売りサインです。3日連続で安値を切り下げる動きは、買い手の完全な敗北を意味します。",
            "高値圏で出現した場合は、早急にポジションを外すことを検討してください。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "下落の果てに現れる、反転を予兆する3本の組み合わせです。2本目の「星」が窓を開けて安値で出現し、3本目の陽線が1本目の陰線の中心より上に届けば、強力な底打ちサインです。",
            "迷わず買いを検討できる非常に信頼度の高いパターンです。",
        ],
    ...
    },
    {
        ...
        "action": "売り（天井を確認して利確）",
        "tips": [
            "上昇トレンドの終焉を示す不吉なサインです。高値圏で窓を開けて星が出現し、その後大陰線で陽線の安値を割り込むようなら、一刻も早い撤退が求められます。",
            "「夜の始まり」を意味し、ここから相場は暗転（下落）する可能性が極めて高いです。",
        ],
    ...
    },
    {
        ...
        "action": "売り（暴落の初動を警戒）",
        "tips": [
            "高値圏で大陰線が3本続くのは、パニック売りや悪材料の織り込み不足を示唆します。各陰線の始値が前日の安値より低く始まる場合は、目も当てられない暴落に発展することがあります。",
            "勇気を持って一度キャッシュポジションに戻るべき、不吉なサインです。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "4本の足の間で合計3つの窓を空けて急落する形です。相場がパニック状態にあり、売られすぎの極致に達していることを示します。",
            "「三空踏み上げ」の逆で、非常に強力なリバウンドが期待できる買い場（底打ち）となります。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "大陽線の後に小陰線が3本続くのは、上昇力を蓄えるための健全な休憩（押し目）です。5本目の足が大陽線となり、1本目の高値を抜ければ、上昇トレンドはさらに加速します。",
            "休んでいる間に売られすぎないことが、強いトレンドの条件です。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "大陰線の後の小陽線3本は、ただの自律反発に過ぎません。5本目の大陰線が1本目の安値を更新すれば、下落トレンドの継続は決定的となります。",
            "中途半端なリバウンドで買わず、安値更新を待って売りで付いていきましょう。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "前後の足から窓を空けて完全に孤立した十字線は、トレンドが極限まで達して完全に力尽きたことを示します。安値圏なら「買い」、高値圏なら「即売り」の極めて強力なサインです。",
            "滅多に出現しませんが、信頼性は全パターンの中でもトップクラスです。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "上昇の勢いの中で一時的に利確売りが出ましたが、すぐさま買い戻された「押し目」の形です。真ん中の陰線を次の陽線がすぐに上書きすれば、上昇トレンド継続は安泰です。",
            "深い調整（押し）にならないため、非常に強い地合いであることを示しています。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "底値圏で3つの谷を作る「逆三尊」は、これ以上下がらないという強固な意志の表れです。左右の谷よりも中央の谷が深いことが特徴で、ネックラインを突破すれば大相場へ発展する可能性が高いです。",
            "多くの投資家が注目する「鉄板」の底入れサインです。",
        ],
    ...
    },
    {
        ...
        "action": "様子見（レンジを上抜けるまで待ち）",
        "tips": [
            "「はらみ足」の後にレンジを抜けきれない状態です。方向感が完全に定まっていないため、初日の大足の高値または安値をどちらに放れるかを確認するまで静観が賢明です。",
            "エネルギーは十分蓄積されており、放れた時の動きは大きくなります。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "窓と窓に挟まれて価格帯が孤立する形は、市場心理の劇的な変化（パニックや熱狂の終了）を意味します。孤島のようになった価格帯が強力な壁となり、以後その価格帯に戻るのは困難になります。",
            "放れた方向に強いトレンドが発生するため、逆らわずに付いていきましょう。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "3つの山（高値）を作る「三山」は、上昇エネルギーが三度試して尽きたことを示す最も有名な天井サインです。ネックラインを割り込むと、長期的な下落トレンドへの入り口となります。",
            "「酒田五法」における代表的な天井サインであり、警戒が必要です。",
        ],
    ...
    # Reference Patterns (Windows/Gaps)
    {
        ...
        "tips": [
            "前日の価格帯を飛び越えて高く始まるのは、買い意欲が極めて強い証拠です。窓が埋まらない限り、上昇トレンドは加速しやすくなります。",
            "ただし、あまりに大きな窓は、寄り付き後の利益確定売りに押されるリスクがあるため注意しましょう。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "前日の価格帯を下抜けて低く始まるのは、失望売りが集中している極めて弱い状態です。この窓が埋まらずに下げ続ける場合、長期的な下落トレンドに繋がる恐れがあります。",
            "安易な「リバウンド狙い」は避け、パニックが収まるのを待ちましょう。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "窓を空けて上昇した後の調整で、その空白（窓）を埋める動きを指します。窓は埋まると、そこが強力な支持（あるいは抵抗）として機能することが多いです。",
            "窓を埋めた直後の反転は、絶好のトレンド再開ポイントとなることがあります。",
        ],
    ...
    },
    {
        ...
        "action": "買い（強いトレンドに乗る）",
        "tips": [
            "窓を開けて上昇したあと、窓を埋めることなくエネルギーを蓄積し、再び上抜ける極めて強い形です。窓を開けるエネルギーが一時的なものではなく、本物であることを示しています。",
            "最強の上昇トレンド継続サインの一つです。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "三山・三川・三空・三兵・三法の五つの法則を指します。市場参加者の熱狂と絶望を読み解くための「哲学」とも呼べる基本原則です。",
            "江戸時代の米相場から続くこの英知は、現代の株式相場でも極めて有効です。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "長期間続いた均衡（レンジ）を上抜けるのは、新しいトレンドが発生した強力なサインです。溜め込んだエネルギーが一気に解放されるため、大きな上昇が期待できます。",
            "ブレイクしたラインが、今度は強力な支持線（サポート）として機能するようになります。",
        ],
    ...
    },
    {
        ...
        "tips": [
            "出来高を伴った窓開けは、機関投資家などの大口の資金が流入している証拠です。単なる窓開けよりも信頼性が格段に高く、その後のトレンドが長続きする傾向があります。",
            "窓開け当日の出来高が直近平均の数倍あれば、非常に強力なサインです。",
        ],
...
def _trend_label(points: List[Dict[str, Any]]) -> str:
    ...
    label = get_direction_label(
        closes,
        positive_label="トレンド相場：上昇",
        negative_label="トレンド相場：下落",
        neutral_label="レンジ相場：もみ合い",
    )
    return label
...
def _build_signals(points: List[Dict[str, Any]]) -> List[Dict[str, str]]:
    ...
    rsi_label = (
        ...
        else "売られすぎ" if rsi_val is not None and rsi_val <= 30 else "中立"
    )
    signals = [
        {
        ...
        },
        {
            ...
            "detail": (
                f"RSI {rsi_val:.1f} で {rsi_label} 判定です。"
            ...
            "tone": (
                "negative"
                if rsi_val is not None and rsi_val >= 70
                else "positive" if rsi_val is not None and rsi_val <= 30 else "neutral"
            ),
        },
        {
            "title": "MACDの方向性",
...
def _build_risks(
    points: List[Dict[str, Any]], info: Optional[Dict[str, Any]]
) -> List[str]:
    if not points:
...
def get_stock_list(db: Session) -> List[Dict[str, Any]]:
    ...
    for code in get_watchlist_codes(db):
        ...
        if history is not None and not history.empty:
            ...
            high_low_text = (
                f"{math.floor(high_val_num):,} / {math.floor(low_val_num):,}"
            )
...
def get_chart_tab(code: str, interval: str = "1d") -> Dict[str, Any]:
    symbol = format_symbol_for_yfinance(code)
    df = fetch_stock_data(
        symbol, period=PERIOD_BY_INTERVAL.get(interval, "1mo"), interval=interval
    )
    ...
    if interval == "1wk":
        ...
        sma_periods = (
            []
        )  # イントラデイ（日中足）では今のところSMAを表示しない、あるいは短い期間を使用する
    ...
    if df is not None and not df.empty:
        ...
        chart_summary = {
            ...
            "change_icon": change["icon"],
            "timestamp": (
                last_row["date"].strftime("%Y/%m/%d %H:%M")
    ...
    axis_note = (
        "縦軸：価格（小数第1位） / 横軸：時間（HH:mm）"
        if interval in INTRADAY_INTERVALS
        else "縦軸：価格（小数第1位） / 横軸：時間（yyyy/mm/dd）"
    )
    ...
    interval_options = [
        {"value": key, "label": label} for key, label in INTERVAL_LABELS.items()
    ]
...
def get_ai_assist(code: str, interval: str = "1d") -> Dict[str, Any]:
    ...
    return {
        ...
        "is_provisional": (
            ai_prediction.get("is_provisional", True) if ai_prediction else True
        ),
    }
    ...
    fundamental_groups = [
        {
            ...
            "items": [
                {
                    "label": "PER",
                    "value": format_fundamental_value(fundamental.get("PER"), "float"),
                },
                {
                    "label": "PBR",
                    "value": format_fundamental_value(fundamental.get("PBR"), "float"),
                },
            ],
        },
        {
            ...
            "items": [
                {
                    "label": "ROE",
                    "value": format_fundamental_value(
                        fundamental.get("ROE"), "percent"
                    ),
                },
                {
                    "label": "自己資本比率",
                    "value": format_fundamental_value(
                        fundamental.get("自己資本比率"), "percent"
                    ),
                },
            ],
        },
...
def get_dividend_tab(code: str) -> Dict[str, Any]:
    ...
    annual_total = (
        (annual_ordinary or 0) + (annual_special or 0) if latest_year else None
    )
    ...
    kpi = {
        ...
        "annual_ordinary": (
            f"¥{annual_ordinary:,.1f}" if annual_ordinary is not None else "—"
        ),
        "annual_special": (
            f"¥{annual_special:,.1f}" if annual_special is not None else "—"
        ),
    ...
    if len(sorted_years) >= 2:
        ...
        chart["x_labels"] = [
            {"x": pad_left + i * x_step, "label": str(y)}
            for i, y in enumerate(sorted_years)
        ]
...
def get_candle_patterns_page() -> Dict[str, Any]:
    ...
    category_counts = {
        c["key"]: sum(len(group_by_category[g][c["key"]]) for g in group_by_category)
        for c in categories
    }
