...
CANDLE_PATTERN_CARDS = [
    # Basic Bullish
    {
        ...
        "action": "買い（続伸を確認してエントリー）",
        "tips": ["強い買い圧力を示しています。翌日の寄り付きが前日終値より高ければ強い買いサインです。", "出来高が急増している場合は、強い上昇トレンドの初動となる可能性が高いです。"],
        "desc_lead": "流れを変える長い陽線",
        "desc_body": "始値から大きく上昇し、実体が長くなる形です。",
        "detail_desc": "材料が出た直後やトレンド転換の初動で現れやすい長い陽線です。出来高が伴れば信頼度が上がります。",
    ...
    },
    {
        ...
        "action": "警戒（反落を待って利確検討）",
        "tips": ["高値圏で出現した場合、翌日に安値を割り込む動きがあれば反落の可能性が高まります。", "特に上ヒゲが実体の2倍以上長い場合は、強い売り圧力を示唆します。"],
    ...
    },
    {
        ...
        "action": "買い（底打ちを確認後にエントリー）",
        "tips": ["下落局面の安値圏で出た場合、翌日の寄り付きが前日終値より高ければ反発が本格化する期待が高いです。", "長い下ヒゲは、その価格帯に強力な買い支えがあることを示しています。"],
    ...
    },
    {
        ...
        "action": "強気買い（続伸を狙う）",
        "tips": ["迷いのない強い上昇を示しており、翌日も窓を開けて上昇する可能性が高いです。", "ただし、急騰の最終局面で出た場合は「打ち止め」になるリスクもわずかにあります。"],
    ...
    # Basic Bearish
    {
        ...
        "action": "売り（続落に警戒して静観）",
        "tips": ["強い売り圧力を示しており、翌日も安値を更新して始まる場合は続落のリスクが高いです。", "安値圏での自律反発を待つ場合も、まずは下げ止まりのサインを待ちましょう。"],
        "desc_lead": "流れを変える長い陰線",
        "desc_body": "始値から大きく下落し、実体が長くなる形です。",
        "detail_desc": "悪材料直後やトレンド転換の初動で現れやすい陰線です。出来高が伴れば信頼度が上がります。",
        "scene": "悪材料発表直後や急落局面",
        "howto": "実体の長さと出来高の増加を確認する",
    },
    {
    ...
    },
    {
        ...
        "action": "売り（戻り売りを待ってエントリー）",
        "tips": ["上昇の試みが完全に叩き潰された形です。翌日に前日安値を割り込むなら、下落加速を待たずに売りを検討してください。", "非常に弱い形であり、買い向かうのは危険です。"],
    ...
    },
    {
        ...
        "action": "様子見（反転の陽線を待って買い）",
        "tips": ["大きく売られたものの、引けにかけて一定の買い戻しが入った状態です。下げ止まりの期待はありますが、翌日の陽線確認が必要です。", "下ヒゲの長さと始値・終値の距離に注目。"],
    ...
    },
    {
        ...
        "action": "売り、または静観（商いの回復を待つ）",
        "tips": ["一切の買い戻しがない極めて弱い形です。パニック売りが終わるまで、不用意な買いは避けて静観しましょう。", "安値圏での出現は、セリングクライマックス（最後の一押し）になる可能性もあります。"],
