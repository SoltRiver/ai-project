...
class EdinetFinancialExtractor:
    ...
    def _find_value(self, edinet_data, tags: list[str], context_ref: str) -> Optional[float]:
    ...
    def extract_financials(self, xbrl_path: str) -> dict[str, Any]:
        ...
        financials = {
            "revenue": None,
            "operating_profit": None,            "ordinary_profit": None,            "net_profit": None,            "total_assets": None,            "net_assets": None,            "equity": None,            "cash_flows_operating": None,            "cash_flows_investing": None,            "cash_flows_financing": None,            "cash_and_equivalents": None,            "period_start": None,            "period_end": None,            "sec_code": None,            "filer_name": None,            "dividend_total": None,            "dividend_per_share": None        }
        ...
        try:
            ...
            for key, tags in targets_duration.items():
                ...
                if val is None:
                    # Try NonConsolidated
                    val = self._find_value(edinet_data, tags, "CurrentYearDuration_NonConsolidatedMember")
                financials[key] = val
            ...
            for key, tags in targets_instant.items():
                ...
                if val is None:
                    val = self._find_value(edinet_data, tags, "CurrentYearInstant_NonConsolidatedMember")
                financials[key] = val
            ...
            dividend_tags = {
                "dividend_total": [
                    "DividendsPayable", "TotalDividend", "DistributionOfSurplus",
