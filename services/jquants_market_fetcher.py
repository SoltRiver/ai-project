...
class JQuantsMarketFetcher:
    ...
    def get_market_data(
        self, sec_code: str, target_date: Optional[str] = None
    ) -> Dict[str, Any]:
        """
        ...
        try:
            ...
            if info_resp and "data" in info_resp:
                ...
                if items:
                    ...
                    val = latest_info.get("IssuedShares") or latest_info.get(
            ...
            quotes_resp = self.client.get_daily_quotes(
                code=sec_code, from_date=t_from, to_date=targets_to
            )
            quotes = []
            ...
            if market_data["price"] and market_data["shares_outstanding"]:
                market_data["market_cap"] = (
                    market_data["price"] * market_data["shares_outstanding"]
                )
